...
def guess_lang(entry: dict, filename: str) -> str:
    ...
    Supports language tokens anywhere in filename, as standalone segments
    separated by '_' or '-'. Examples:
      - something_en_title.yaml
      - something-kr-v2.yml
      - en_something.yaml

    This token-based approach avoids accidental matches like 'green.yaml'.
    """
